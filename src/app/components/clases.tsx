...
type CourseCardProps = {
  ...
  export default function CourseCard({
    ...
    return (
      ...
      <div className="rounded-2xl shadow p-6 max-w-sm cursor-pointer transition-all duration-300 ease-in-out hover:shadow-5xl hover:scale-105 hover:bg-purple-100">
        <div
